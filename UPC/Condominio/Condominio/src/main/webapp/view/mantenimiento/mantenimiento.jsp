...
<div class="container">
	<div class="row">
		<div class="col-md-3" id="leftCol">
			...
			<div class="well">
				<ul class="nav nav-stacked" id="sidebar">
					<li><a href="MantenimientoResidente">
											Mantenimeinto de Residente</a></li>
		...
		<div class="col-md-9">
			...
			ullam corporis suscipit laboriosam, nisi ut.. <br> Fos qui
...
<jsp:include page="/layout/piepagina.jsp" />
